...
<?php 
              ...
              <div class="row" style = "width:100%">
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <div class="col">
                        ...
                        <select name="status" id="status<?php echo $row_count?>">
                            <option value="Pending">Pending</option>
            ...
            <div class="accordion-body panel-body m-2 pt-2 mt-0">
              <!-- <strong>This is the first item's accordion body.</strong>
               ...
               <div class="row text-muted mt-0" style = "font-size: medium;"> <!--LABEL -->
                ...
                <hr>
                <div class="d-flex align-items-end flex-column mb-3 my-text-small m-0 mb-0 p-0" style="">
                <div class="row ">
                <?php
        ...
        document.getElementById('status$row_count').value = '$stats';
