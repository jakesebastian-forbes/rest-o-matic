...
<!-- 
      <div class = "text-center" style ="background-color: #F1EBE5;width: 80%; height:60%;margin:auto; margin-top:4vh;">  

            <div class = "py-5"style = "font-family: 'Courier New', monospace;">

                <h2 class ="p-3"style="font-size: 5vh;">Rest-o-Matic</h2>  
                <h1 class ="p-3"style="font-size: 6vh;font-weight:bold">09-XXX-XXX-XXX</h1> 
                <h4 class ="p-3"style="font-size: 4vh;">CONTACT NUMBER</h4>
                <h1 class ="p-3"style="font-size: 6vh;font-weight:bold">BRGY. SAMPLE, NASUGBU</h1>
                <h4 class ="p-3"style="font-size: 4vh;"><a onclick="" href="" style="text-decoration: none; color:inherit">ADDRESS</a> </h4>    
      ...
      <div class="text-center" style="margin:7%; margin-bottom: 0px;"> 
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front py-5 text-center" style="font-family: 'Courier New', monospace;">
    
              <h2 class="p-3" style="font-size: 5vh;">Rest-o-Matic</h2>
              <h1 class="p-3" style="font-size: 6vh;font-weight:bold">09-XXX-XXX-XXX</h1>
              <h4 class="p-3" style="font-size: 4vh;">CONTACT NUMBER</h4>
              <h1 class="p-3" style="font-size: 6vh;font-weight:bold">BRGY. SAMPLE, NASUGBU</h1>
              <h4 class="p-3" style="font-size: 4vh;"><a onclick="" href=""
